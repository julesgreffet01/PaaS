        ...
        <div className="flex items-center justify-center flex-col my-7">
          <form onSubmit={publish} className="flex flex-col gap-3 min-w-[350px]">
            <div className="flex flex-col gap-1">
              <Label className="block text-xl font-medium">App Name</Label>
              <Input
                id="appName"
                value={data.appName}
              ...
              />
              {errors.appName && <span className="text-sm text-destructive">{errors.appName}</span>}
            </div>
            <div className="flex flex-col gap-1">
              <Label className="block text-xl font-medium">Type d'application</Label>
              <select
                id="typeAppId"
                className="mt-1 w-full bg-input rounded-sm p-2"
                onChange={(e) => setData('typeAppId', e.target.value)}
              >
              ...
              {errors.typeAppId && (
                <span className="text-sm text-destructive">{errors.typeAppId}</span>
              )}
            </div>
            {data.typeAppId === '2' && (
              <>
